...
output_path = "Hybrid Models with Fine Tunnigs/DenseNet121/Figure And Tables/trainStatistic.txt"
save_statistics_to_file(train_df, "Eğitim", output_path)

output_path = "Hybrid Models with Fine Tunnigs/DenseNet121/Figure And Tables/testStatistic.txt"
...
# & _________________________________________ Fine Tunning İşlemi ________________________________________________
# * 10-) --------------------------------------------------------------------------------------------------------
# Üst katmanların da eğitilebilir hale getirilmesi
...
summary_file_path = os.path.join(output_directory, "DenseNet121_SVM_HybridModel_summary.txt")

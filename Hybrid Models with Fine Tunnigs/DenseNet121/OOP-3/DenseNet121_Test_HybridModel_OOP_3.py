from DenseNetHybridModelFunctions_3 import DenseNetHybridModel
...
class DenseNet121_HybridModel_Test:
    ...
    def fineTuneDensenet121Model(self, model, num_unfreeze_layers, learning_rate):
        return self.model_instance.fine_tune_densenet121_model(
            model, num_unfreeze_layers, learning_rate
        )
...
denseNet121_HybridModel_Test.compileModel(model, learning_rate=0.001)
...
model = denseNet121_HybridModel_Test.fineTuneDensenet121Model(model, 30, 0.0001)

from DenseNetHybridModelFunctions import DenseNetHybridModel
...
class DenseNet121_HybridModel_Test:
    ...
    def createDensenet121Model(
        self, input_shape, num_classes, trainable_layers=0, learning_rate=0.0001
    ):
        return self.model_instance.create_densenet121_model(
            input_shape, num_classes, trainable_layers, learning_rate
        )
